...
print('\nExercício B - Quantas impressões "oi"')
cont = 0
for i in range(1,9+1):
    if i != 3:
        for j in range(1,6+1):
            cont = cont + 1
print(f'\nQuantidade de impressões = {cont}')

################ Exercício C ######################

print('\nExercicío C - Números pares e divisiveis por 7')
cont = 0
for x in range(1067-1, 3627+1):
    if x % 2 == 0 and x % 7 == 0:
        cont = cont + 1
print(f'\nQuantidade de números PARES E DIVISÍVEIS por 7 = {cont}')

################ Exercício D ######################

print('\nExercício D - Número sortudo')
cont = 0
...
for x in range(18644,33087):
    if '2' in str(x):
        ...
        if '7' in str(x):
            cont = cont - 1 
print(f'\nTotal de números SORTUDOS = {cont}')

################ Exercício E ######################

print('\nExercício E - Telefones')
...
def main():
    ...
    for x in fone:
        if condicao_2(x):
            cont = cont + 1
            if condicao_1(x) or condicao_3(x):
                cont = cont - 1
    print(f'\nResultado: {cont}')
